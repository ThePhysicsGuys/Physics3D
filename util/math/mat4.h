...
public:
	...
	Mat4Template(double m00, double m01, double m02, double m03, double m10, double m11, double m12, double m13, double m20, double m21, double m22, double m23, double m30, double m31, double m32, double m33) :
	...
	Mat4Template(const double other[16]) {
		for (int i = 0; i < 16; i++) {
			m[i] = other[i];
		}
	};
	...
	Mat4Template translate(double x, double y, double z) {
	...
	Mat4Template rotate(double angle, double x, double y, double z) {
		double s = sin(angle);
		double c = cos(angle);
		double C = (1.0 - c);

		double rm00 = x * x * C + c;
		double rm01 = x * y * C + z * s;
		double rm02 = x * z * C - y * s;
		double rm10 = x * y * C - z * s;
		double rm11 = y * y * C + c;
		double rm12 = y * z * C + x * s;
