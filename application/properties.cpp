...
std::string PropertiesParser::ltrim(std::string string) {
...
std::string PropertiesParser::rtrim(std::string string) {
...
std::string PropertiesParser::trim(std::string string) {
