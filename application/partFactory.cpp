...
ExtendedPart* createUniquePart(Screen& screen, const Shape& hitbox, const VisualShape& visualShape, CFrame position, double density, double friction, std::string name) {
