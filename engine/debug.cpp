...
namespace Debug {
	...
	void logVec(Vec3 origin, Vec3 vec, VectorType type) { logVecAction(origin, vec, type); };
	...
	void setVecLogAction(void(*logger)(Vec3 origin, Vec3 vec, VectorType type)) { logVecAction = logger; };
